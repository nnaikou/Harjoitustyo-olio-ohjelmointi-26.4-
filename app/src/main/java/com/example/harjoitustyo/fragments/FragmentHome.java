...
public class FragmentHome extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        buttonMove = view.findViewById(R.id.btnMoveLutemonsFromHome);

        // lets fetch the lutemons from home
        lutemons = home.getLutemonsInArray();
